...
const styles = {
  ...
  docCard: { background: '#ffffff', border: '2.5px solid #0f0a1e', borderRadius: '14px', padding: '24px', boxShadow: '4px 4px 0px #0f0a1e', cursor: 'pointer', display: 'flex', flexDirection: 'column', gap: '12px', transition: 'transform 0.1s' },
